...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        ...
        {if $user->isLogin}
            <div class="row center">
                <a href="/user" id="download-button" class="btn-large waves-effect waves-light orange">进入后台</a>
            </div>
        {else}
        <div class="row center">
            <a href="/auth/register" id="download-button" class="btn-large waves-effect waves-light orange">免费注册</a>
        </div>
        {/if}
        <br><br>
    </div>
